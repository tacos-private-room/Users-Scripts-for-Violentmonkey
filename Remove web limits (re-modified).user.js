...
(function() {
    ...
    function addBtn(){
        ...
        // node.innerHTML = '<label>Restriction <input type="checkbox"  name="" id="black_node"></label>';
        node.innerHTML = '<button type="button" id="rwl-setbtn"> set </button> <lalala style="cursor:move;">Restriction</lalala> <input type="checkbox" name="" id="black_node" >';
    ...
    document.querySelector("#rwl-setbtn").addEventListener("click",function(){
        ...
        var innerH = "" +
            ...
            "<laberl> <p>Allow uploading blacklists<input id='uploadchecked'  type='checkbox' " + upload_checked + "></p>" + "</laberl>" +
            ...
            "<button id='rwl-setMenuSave'>Save</button> &nbsp;&nbsp;&nbsp;" +
            "<button id='rwl-setMenuClose' onclick='this.parentNode.parentNode.removeChild(this.parentNode);' >Close</button> &nbsp;&nbsp;&nbsp;" +
            // "<button id='rwl-codeboxsave'>Save</button>" +
            "<span style='font-size:0.7em;'>-- La la la，La la la， --</span>" +
            ""
        "";
