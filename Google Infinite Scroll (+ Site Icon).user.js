...
#botstuff [role="navigation"] {visibility: hidden; height: 0;}

/* page counter */
#res[role="main"] {counter-increment: number; border-top: solid ${window.getComputedStyle( document.body ).getPropertyValue('border-color')} 1px; }
#res[role="main"]::before {content: counter(number); font-size: 14px; position: absolute; right: 0; margin-top: -10px; padding-right: 8px; padding-left: 12px; background-color: ${window.getComputedStyle( document.body ).getPropertyValue('background-color')}}
`
